...
QVHistogram::QVHistogram(const QwtText &title):
    QwtPlotItem(title)
{
    init();
}

QVHistogram::QVHistogram(const QString &title):
    QwtPlotItem(QwtText(title))
{
    init();
}

QVHistogram::~QVHistogram()
{
    delete d_data;
}

void QVHistogram::init()
{
    d_data = new PrivateData();
    d_data->reference = 0.0;
    d_data->attributes = QVHistogram::Auto;
...
void QVHistogram::setBaseline(double reference)
{
...
double QVHistogram::baseline() const
{
    return d_data->reference;
}

void QVHistogram::setData(const QwtIntervalData &data)
{
    d_data->data = data;
    itemChanged();
}

const QwtIntervalData &QVHistogram::data() const
{
    return d_data->data;
}

void QVHistogram::setColor(const QColor &color)
{
...
QColor QVHistogram::color() const
{
    return d_data->color;
}

QwtDoubleRect QVHistogram::boundingRect() const
{
...
int QVHistogram::rtti() const
{
    return QwtPlotItem::Rtti_PlotHistogram;
}

void QVHistogram::setHistogramAttribute(HistogramAttribute attribute, bool on)
{
...
bool QVHistogram::testHistogramAttribute(HistogramAttribute attribute) const
{
    return d_data->attributes & attribute;
}

void QVHistogram::draw(QPainter *painter, const QwtScaleMap &xMap, 
    const QwtScaleMap &yMap, const QRect &) const
{
    ...
    {
        if ( d_data->attributes & QVHistogram::Xfy )
        {
...
void QVHistogram::drawBar(QPainter *painter,
